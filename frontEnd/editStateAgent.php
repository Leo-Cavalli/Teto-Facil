...
<head>
    ...
    <link rel="stylesheet" href="Stylesheets/updateAgent.css">
    <title>Edição de corretor</title>
</head>
<body>
    <h1>Edição de Corretor: <?=$_GET['name']?></h1>
    <div class="link"><a href="adminPage.php">Voltar a Página de Administrador!</a></div>
    <div class="infoAdmin">
        <table>
            <tr>
    ...
    <?php
        ...
        if(isset($_GET['op']) && $_GET['op'] == 'editName'){
            echo '<form action="../updateProfile.php" method="post">
                    ...
                    <input class="button-form" type="submit" value="Editar Nome">
                </form>'
                ;
        }
        ...
        if(isset($_GET['op']) && $_GET['op'] == 'editEmail'){
            echo '<form action="../updateProfile.php" method="post">
                    <label class="label" for="newEmail">Novo Email:</label>
                    ...
                    <input type="hidden" name="oldTelefone" value="'.$auxUser->getTelefone().'">
                    <input type="hidden" name="oldCreci" value="'.$auxUser->getCreci().'">
                    <input class="button-form" type="submit" value="Editar Email">
                </form>';
        }

        if(isset($_GET['op']) && $_GET['op'] == 'editCpf'){
            echo '<form action="../updateProfile.php" method="post">
                    <label class="label" for="newCpf">Novo CPF:</label>
                    ...
                    <input type="hidden" name="oldTelefone" value="'.$auxUser->getTelefone().'">
                    <input type="hidden" name="oldCreci" value="'.$auxUser->getCreci().'">
                    <input class="button-form" type="submit" value="Editar CPF">
                    <script>
        ...
        if(isset($_GET['op']) && $_GET['op'] == 'editCreci'){
            echo '<form action="../updateProfile.php" method="post">
                    <label class="label" for="newCreci">Novo Creci:</label>
                    ...
                    <input type="hidden" name="oldCpf" value="'.$auxUser->getCpf().'">
                    <input type="hidden" name="oldTelefone" value="'.$auxUser->getTelefone().'">
                    <input class="button-form" type="hidden" name="oldCreci" value="'.$auxUser->getCreci().'">
                    <input class="button-form" type="submit" value="Editar Creci">
                </form>';
        }

        if(isset($_GET['op']) && $_GET['op'] == 'editTelefone'){
            echo '<form action="../updateProfile.php" method="post">
                    <label class="label" for="newTelefone">Novo Telefone:</label>
                    ...
                    <input type="hidden" name="oldTelefone" value="'.$auxUser->getTelefone().'">
                    <input type="hidden" name="oldCreci" value="'.$auxUser->getCreci().'">
                    <input class="button-form" type="submit" value="Editar Telefone">
                </form>';
        }
        ...
        if(isset($_GET['op']) && $_GET['op'] == 'editPassword'){
            echo '<form action="../updateProfile.php" method="post">
                    ...
                    <input type="hidden" name="oldTelefone" value="'.$auxUser->getTelefone().'">
                    <input type="hidden" name="oldCreci" value="'.$auxUser->getCreci().'">
                    <input class="button-form" type="submit" value="Editar Senha">
                </form>';
        }
